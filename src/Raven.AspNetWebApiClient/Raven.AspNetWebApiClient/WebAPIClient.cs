...
namespace Raven.AspNetWebApiClient
{
    ...
    /// 
    /// </summary>
    public abstract class WebAPIClient<RT> : IWebAPIClient, IWebAPIClientAsync
            where RT : class, new()
    {
        ...
        public WebAPIClient(string baseUrl, string mediaType = MediaType.json, int timeout = 10000)
        {
