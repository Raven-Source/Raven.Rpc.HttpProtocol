...
namespace Raven.WebAPI.Controllers
{
    public class TestController : ApiController
    {
        ...
        public async Task<string> Get3()
        {
            ...
            string res = "location:" + WebAPI.Controllers.ValuesController.location.ToString()
                + ",workerThreads:" + workerThreads + ",completionPortThreads:" + completionPortThreads;

            ThreadPool.GetMinThreads(out workerThreads, out completionPortThreads);
            res += ",MinworkerThreads:" + workerThreads + ",MincompletionPortThreads:" + completionPortThreads;
